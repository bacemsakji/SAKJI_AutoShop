...
- **Product Catalog**: Browse and search automotive parts with filtering by category, manufacturer, and vehicle compatibility
...
- **Multi-language Support**: Built-in internationalization (i18n) context
...
│   │   ├── pages/           # Page components (Home, Parts, ProductDetail)
│   │   ├── api/             # API client functions
│   │   ├── hooks/           # Custom React hooks
│   │   ├── context/         # React context providers
│   │   ├── data/            # Static data (parts, testimonials)
...
│   │   ├── lib/             # Utility libraries (AI, cache)
...
- **Home Page**: Hero section, featured parts, testimonials
- **Parts Catalog**: Grid view with filtering and search
- **Product Detail**: Detailed part information with specifications
